<?php
	...
	class fuFacebook extends fs_boot {
		...
		public function login_facebook() {
			wp_redirect( 'https://www.facebook.com/v2.9/dialog/oauth?client_id=' . $this->client_id . '&response_type=code&redirect_uri=' . urlencode( home_url( '/' ) ) . '&auth_type=request&scope=email' );
			exit();
		}
